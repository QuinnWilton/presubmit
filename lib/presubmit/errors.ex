defmodule Presubmit.GitError do
  @moduledoc """
...
defmodule Presubmit.MergeCommitError do
  @moduledoc """
  ...
  def message(%__MODULE__{sha: sha, parents: parents}) do
    ...
    presubmit needs a single parent to compute a change set. If this is CI \
...
defmodule Presubmit.ShallowCloneError do
  @moduledoc """
...
defmodule Presubmit.NoMessageError do
  @moduledoc """
  ...
  def message(%__MODULE__{source: source}) do
    ...
    Guard message assertions with `if Presubmit.Query.has_message?(commit)`, \
