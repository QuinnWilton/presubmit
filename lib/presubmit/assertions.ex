defmodule Presubmit.Assertions do
  @moduledoc """
  ExUnit assertion verbs over a `Presubmit.Commit`.
  ...
  arguments accept any `Presubmit.Pattern`: a `Regex`, an exact path
  ...
  Library-aware verbs live in `Presubmit.Assertions.Phoenix`, `.Ecto`,
  `.OTP`, `.ExUnit`, `.Mix`, and `.Changelog`; `use Presubmit` imports
  them all.
  ...
  For Ecto migrations prefer `Presubmit.Assertions.Ecto.assert_migrations_ordered/1`,
  ...
  For Phoenix routers use `Presubmit.Assertions.Phoenix.assert_routed/1`,
