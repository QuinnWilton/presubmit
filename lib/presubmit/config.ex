defmodule Presubmit.Config do
  @moduledoc """
  Loads the rule configuration from `.presubmit.exs`, or builds a
  default one from what the examined tree and the VM contain.

  The file evaluates to a list of rule-set specs (see `Presubmit.RuleSet`):
  ...
  alias Presubmit.{Commit, MixFile, Rule, Rules, RuleSet, Tree}
  ...
  @doc """
  Loads `path` (default `.presubmit.exs` under `opts[:repo]`), falling
