defmodule Presubmit.Assertions.Phoenix do
  @moduledoc """
  Assertions over Phoenix routers, controllers, and LiveViews, built on
  `Presubmit.Adapters.PhoenixRouter` and `Presubmit.Adapters.PhoenixHandler`.
  """

  alias Presubmit.Adapters.{PhoenixHandler, PhoenixRouter}
  alias Presubmit.Assertions.Flunk
  alias Presubmit.{Commit, Paths, Source}
  alias Presubmit.Source.Index
