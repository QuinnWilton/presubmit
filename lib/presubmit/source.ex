defmodule Presubmit.Source do
  ...
  alias Presubmit.{Adapter, Commit, Pattern, Tree}
  alias Presubmit.Source.{Diff, Index}
  ...
  def find(%Tree{} = tree, adapter, pattern \\ Presubmit.Paths.elixir_source()) do
